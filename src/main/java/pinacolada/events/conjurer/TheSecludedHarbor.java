...
public class TheSecludedHarbor extends PCLEvent
{
    ...
    private static class Introduction extends EYBEventPhase<TheSecludedHarbor, TheSecludedHarbor.EventStrings>
    {
        private final AbstractCard obtainedCard = new BlazingHeat();
    ...
    private static class PhaseFight extends EYBEventPhase<TheSecludedHarbor, TheSecludedHarbor.EventStrings>
    {
        @Override
        protected void OnEnter()
        {
    ...
    private static class PhaseTrap extends EYBEventPhase<TheSecludedHarbor, TheSecludedHarbor.EventStrings>
    {
        @Override
        protected void OnEnter()
        {
    ...
    private static class Conclusion extends EYBEventPhase<TheSecludedHarbor, TheSecludedHarbor.EventStrings>
    {
        @Override
        protected void OnEnter()
        {
