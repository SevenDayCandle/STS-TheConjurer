...
public class ConjurerStrings extends AbstractStrings {
    ...
    public final String combat_conjurerMeterReaction = combat.TEXT[0];
    ...
    public final String conjurerInteractive1 = tutorial.TEXT[4];
    public final String conjurerInteractive2 = tutorial.TEXT[5];
    public final String conjurerInteractive3 = tutorial.TEXT[6];
    public final String conjurerInteractive4 = tutorial.TEXT[7];
    public final String conjurerSummonInteractive1 = tutorial.TEXT[8];
    public final String conjurerSummonInteractive2 = tutorial.TEXT[9];
    public final String conjurerSummonInteractive3 = tutorial.TEXT[10];
    public final String conjurerSummonInteractive4 = tutorial.TEXT[11];
