...
public class Ranni extends PCLCard {
    ...
    public void setup(Object input) {
        ...
        addGainPower(PTrigger.when(PCond.checkPower(PCLCardTarget.Any, 1, PCLPowerData.Weak, PCLPowerData.Vulnerable), PMove.applyToRandom(4, CooledPower.DATA).setUpgrade(2)));
    }
}
