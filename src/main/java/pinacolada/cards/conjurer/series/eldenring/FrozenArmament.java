...
public class FrozenArmament extends PCLCard {
    ...
    public void setup(Object input) {
        addGainPower(2, PTrigger.when(PCond.isAttacking(PCLCardTarget.Self), PMove.applyToSingle(2, PCLElementHelper.Gelus, PCLElementHelper.Frostbite).setUpgrade(1)));
    }
}
