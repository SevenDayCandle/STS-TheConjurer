...
public class OrbCore_Water extends PCLCard
{
    public static final PCLCardData DATA = register(OrbCore_Water.class, ConjurerResources.conjurer)
    ...
    {
        addGainPower(PTrigger.passive(new PCond_IfIsOrb(PCLOrbHelper.Water), new PMod_PerAffinityLevel(1, PCLAffinity.Blue), new PTrait_OrbFocus(1).setUpgrade(1)));
