...
public class OrbCore_Earth extends PCLCard
{
    public static final PCLCardData DATA = register(OrbCore_Earth.class, ConjurerResources.conjurer)
    ...
    {
        addGainPower(PTrigger.passive(new PCond_IfIsOrb(PCLOrbHelper.Earth), new PMod_PerAffinityLevel(1, PCLAffinity.Orange), new PTrait_OrbFocus(1).setUpgrade(1)));
